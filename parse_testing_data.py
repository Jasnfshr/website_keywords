...
def analyze_webpages(file_chunk,block_index):
	...
	#this defaults the value to 0
	#not 100% necessary, but can be kept for consistency
	for filename in training_files:
		training_samples = training_dictionary[filename]
		for nval,gram_dictionary in training_samples.iteritems():
			for entry in gram_dictionary:
				gram_dictionary[entry]['is_keyword'] = 0
	...
	print 'DONE WITH BLOCK ' + str(block_index)
	print '========================'
